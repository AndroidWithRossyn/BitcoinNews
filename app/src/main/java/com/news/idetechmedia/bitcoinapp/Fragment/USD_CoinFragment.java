...
public class USD_CoinFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_u_s_d__coin, container, false);
        WebView webView = view.findViewById(R.id.webView25);
        progress_bar = view.findViewById(R.id.progress_bar25);
        ...
        webView.reload();
        webView.loadUrl(getString(R.string.usdcoin_news));  // Url of portal is passed
