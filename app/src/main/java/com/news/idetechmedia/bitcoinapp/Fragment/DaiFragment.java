...
public class DaiFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_dai, container, false);
        WebView webView = view.findViewById(R.id.webView8);
        progress_bar = view.findViewById(R.id.progress_bar8);
        ...
        webView.reload();
        webView.loadUrl(getString(R.string.dai_news));  // Url of portal is passed
