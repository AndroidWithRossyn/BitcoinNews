...
public class Matic_NetworkFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_matic__network, container, false);
        WebView webView = view.findViewById(R.id.webView15);
        ...
        webView.reload();
        progress_bar = view.findViewById(R.id.progress_bar15);
        webView.loadUrl(getString(R.string.dash_news));  // Url of portal is passed
