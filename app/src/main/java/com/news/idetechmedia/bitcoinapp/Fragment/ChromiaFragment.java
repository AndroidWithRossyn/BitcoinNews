...
public class ChromiaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_chromia, container, false);
        WebView webView =view.findViewById(R.id.webView6);
        progress_bar=view.findViewById(R.id.progress_bar5);
        ...
        webView.reload();
        webView.loadUrl(getString(R.string.chromia_news));  // Url of portal is passed
