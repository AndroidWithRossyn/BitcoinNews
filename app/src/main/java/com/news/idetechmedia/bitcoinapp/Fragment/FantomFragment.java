...
public class FantomFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_fantom, container, false);
        WebView webView = view.findViewById(R.id.webView12);
        progress_bar = view.findViewById(R.id.progress_bar12);
