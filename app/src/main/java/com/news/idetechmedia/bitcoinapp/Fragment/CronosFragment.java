...
public class CronosFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_cronos, container, false);
        WebView webView = view.findViewById(R.id.webView7);
        progress_bar = view.findViewById(R.id.progress_bar7);
        ...
        webView.reload();
        webView.loadUrl(getString(R.string.cronos_news));  // Url of portal is passed
