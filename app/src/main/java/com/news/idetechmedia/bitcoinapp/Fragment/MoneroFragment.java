...
public class MoneroFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_monero, container, false);
        WebView webView = view.findViewById(R.id.webView16);
        progress_bar = view.findViewById(R.id.progress_bar16);
        ...
        webView.reload();
        webView.loadUrl(getString(R.string.monera_news));  // Url of portal is passed
