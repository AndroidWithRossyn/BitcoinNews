...
public class SolanaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_solana, container, false);
        WebView webView = view.findViewById(R.id.webView21);
        progress_bar = view.findViewById(R.id.progress_bar21);
        ...
        webView.reload();
        webView.loadUrl(getString(R.string.solana_news));  // Url of portal is passed
