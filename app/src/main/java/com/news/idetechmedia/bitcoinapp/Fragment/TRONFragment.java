...
public class TRONFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_t_r_o_n, container, false);
        ...
        webView.reload();
        webView.loadUrl(getString(R.string.tron_news));  // Url of portal is passed
