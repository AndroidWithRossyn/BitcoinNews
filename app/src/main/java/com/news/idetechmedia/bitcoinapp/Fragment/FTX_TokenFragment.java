...
public class FTX_TokenFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_f_t_x__token, container, false);
        WebView webView = view.findViewById(R.id.webView13);
        progress_bar = view.findViewById(R.id.progress_bar13);
        ...
        webView.reload();
        webView.loadUrl(getString(R.string.fantom_news));  // Url of portal is passed
