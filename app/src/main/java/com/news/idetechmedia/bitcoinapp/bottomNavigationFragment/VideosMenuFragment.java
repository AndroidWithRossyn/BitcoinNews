package com.news.idetechmedia.bitcoinapp.bottomNavigationFragment;
...
public class VideosMenuFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_videos_menu, container, false);
        WebView webView = view.findViewById(R.id.webView28);
        progress_bar = view.findViewById(R.id.progress_bar28);
        ...
        webView.reload();
        webView.loadUrl(getString(R.string.videos_news));  // Url of portal is passed
