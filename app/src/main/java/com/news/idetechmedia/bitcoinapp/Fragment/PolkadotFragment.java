...
public class PolkadotFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_polkadot, container, false);
        WebView webView = view.findViewById(R.id.webView17);
        progress_bar = view.findViewById(R.id.progress_bar17);
        ...
        webView.reload();
        webView.loadUrl(getString(R.string.polkadot_news));  // Url of portal is passed
