...
public class RippleFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        WebView webView = view.findViewById(R.id.webView19);
        progress_bar = view.findViewById(R.id.progress_bar19);
        ...
        webView.reload();
        webView.loadUrl(getString(R.string.ripple_news));  // Url of portal is passed
