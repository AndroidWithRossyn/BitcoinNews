...
public class CosmosFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_cosmos, container, false);
        WebView webView = view.findViewById(R.id.webView6);
        progress_bar = view.findViewById(R.id.progress_bar6);
        ...
        webView.reload();
        webView.loadUrl(getString(R.string.cosmos_news));  // Url of portal is passed
