...
public class TerraFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_terra, container, false);
        WebView webView = view.findViewById(R.id.webView23);
        progress_bar = view.findViewById(R.id.progress_bar23);
        ...
        webView.reload();
        webView.loadUrl(getString(R.string.terra_news));  // Url of portal is passed
