...
public class TetherFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_tether, container, false);
        WebView webView = view.findViewById(R.id.webView24);
        progress_bar = view.findViewById(R.id.progress_bar24);
        ...
        webView.reload();
        webView.loadUrl(getString(R.string.tether_news));  // Url of portal is passed
