...
public class BNBFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_b_n_b, container, false);
        WebView webView =view.findViewById(R.id.webView3);
        progress_bar=view.findViewById(R.id.progress_bar3);
        ...
        webView.loadUrl(getString(R.string.bnb_news));  // Url of portal is passed
