...
public class TrendingMenuFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_trending_menu, container, false);
        WebView webView = view.findViewById(R.id.webView27);
        progress_bar = view.findViewById(R.id.progress_bar27);
        ...
        webView.reload();
        webView.loadUrl(getString(R.string.trending_news));  // Url of portal is passed
