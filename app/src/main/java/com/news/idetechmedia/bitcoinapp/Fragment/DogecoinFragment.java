...
public class DogecoinFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_dogecoin, container, false);
        WebView webView = view.findViewById(R.id.webView9);
        progress_bar = view.findViewById(R.id.progress_bar9);
        ...
        webView.reload();// Url of portal is passed
        webView.loadUrl(getString(R.string.dogecoin_news));
