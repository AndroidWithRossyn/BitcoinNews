...
public class StellarFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_stellar, container, false);
        WebView webView = view.findViewById(R.id.webView22);
        progress_bar = view.findViewById(R.id.progress_bar22);
        ...
        webView.reload();
        webView.loadUrl(getString(R.string.stellar_news));
// Url of portal is passed
