...
public class Shiba_InuFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_shiba__inu, container, false);
        WebView webView = view.findViewById(R.id.webView20);
        progress_bar = view.findViewById(R.id.progress_bar20);
        ...
        webView.reload();
        webView.loadUrl(getString(R.string.shibainu_news));  // Url of portal is passed
