...
public class LitecoinFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_litecoin, container, false);
        WebView webView = view.findViewById(R.id.webView14);
        progress_bar = view.findViewById(R.id.progress_bar14);
        ...
        webView.reload();
        webView.loadUrl(getString(R.string.litecoin_news));  // Url of portal is passed
