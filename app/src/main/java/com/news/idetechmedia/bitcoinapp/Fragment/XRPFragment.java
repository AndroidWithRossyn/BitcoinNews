...
public class XRPFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_x_r_p, container, false);
        WebView webView = view.findViewById(R.id.webView26);
        progress_bar = view.findViewById(R.id.progress_bar26);
        ...
        webView.reload();
        webView.loadUrl(getString(R.string.xrp_news));  // Url of portal is passed
