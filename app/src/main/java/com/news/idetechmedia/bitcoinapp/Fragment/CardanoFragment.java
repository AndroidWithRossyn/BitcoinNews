...
public class CardanoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_cardano, container, false);
        WebView webView =view.findViewById(R.id.webView4);
        progress_bar=view.findViewById(R.id.progress_bar4);
        ...
        webView.reload();
        webView.loadUrl(getString(R.string.cardano_news));  // Url of portal is passed
